{
	"targets": [{
		...
		"defines": [
			"<!@(node ./install/getEnvPaths.js OPENCV4NODEJS_DEFINES)",
		],
		"include_dirs" : [
			"<!@(node ./install/getEnvPaths.js OPENCV4NODEJS_INCLUDES)",
			"cc",
			"cc/core",
			"<!(node -e \"require('nan')\")",
		...
		"libraries": [
			"<!@(node ./install/getEnvPaths.js OPENCV4NODEJS_LIBRARIES)",
		],
		"sources": [
			"cc/opencv4nodejs.cc",
